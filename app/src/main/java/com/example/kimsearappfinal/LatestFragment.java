...
public class LatestFragment extends Fragment {
    ...
    private void initializeData() {
        ...
        categoryList.add(new MyDataModel("Predator", "Built for speed, traction and stability on natural grass fields", imageIds2, 33.33F));

        List<Integer> imageIds3 = new ArrayList<>();
        imageIds3.add(R.drawable.nike_superfly9elite_mercurial_dream_speed);
        categoryList.add(new MyDataModel("SuperflyElite", "Built for speed, traction and stability on natural grass fields", imageIds3, 33.33F));

        List<Integer> imageIds4 = new ArrayList<>();
        imageIds4.add(R.drawable.futur_ultimate);
        categoryList.add(new MyDataModel("Future Ultimate", "Built for speed, traction and stability on natural grass fields", imageIds4, 33.33F));

        List<Integer> imageIds5 = new ArrayList<>();
        imageIds5.add(R.drawable.future_ultimatenew);
        categoryList.add(new MyDataModel("FutureNew", "Built for speed, traction and stability on natural grass fields", imageIds5, 33.33F));
    }
