...
public class PopularFragment extends Fragment {
    ...
    private void initializeData() {
        ...
        imageIds2.add(R.drawable.future_ultimatenew);
        categoryList.add(new MyDataModel("FutureNew", "Built for speed, traction and stability on natural grass fields.", imageIds2, 33.33F));

        List<Integer> imageIds3 = new ArrayList<>();
        imageIds3.add(R.drawable.futur_ultimate);
        categoryList.add(new MyDataModel("Future Ultimate", "Built for speed, traction and stability on natural grass fields", imageIds3, 33.33F));

        List<Integer> imageIds4 = new ArrayList<>();
        imageIds4.add(R.drawable.adidas_predator_elite);
        categoryList.add(new MyDataModel("Title 4", "Built for speed, traction and stability on natural grass fields", imageIds4, 33.33F));
